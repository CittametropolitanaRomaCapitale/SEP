...
public class EmailQueue {
    ...
    public static boolean enqueue(Long id) {
        ...
        log.info("ID Email: {} aggiunta alla coda", id);
        return offered;
    }
    ...
    public static void incrementRetry(Long id) {
        ...
        log.debug("Incremento retry per ID {} (errore generico): tentativo #{}", id, retry);
    }
    ...
    public static void incrementEsitoRetry(Long id) {
        ...
        log.debug("Incremento retry per ID {} (esito=false): tentativo #{}", id, retry);
    }
