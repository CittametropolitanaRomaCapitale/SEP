...
import { TableContattiGruppoButtons } from '../buttons/table_buttons/TableContattiGruppoButtons';

export const useContattiGruppoTable = () => {
  ...
  const columns: ColumnDef<Anagrafica>[] = [
    {
      id: 'certificato',
      header: '',
      enableSorting: false,
    ...
    },
    {
      ...
      cell: ({ row: { original } }) => (
        (isUserPIAdmin || isUserArchivista) ?
          <TableContattiGruppoButtons contatto={original} /> : null
      )
    }
  ];
