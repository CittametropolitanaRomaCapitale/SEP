...
import { ConservazioneLayout } from '../../features/utilità/configurazioni/configurazioni_pec_peo/gestione_conservazione/layouts/ConservazioneLayout';

const ConservazionePage: NextPage = () => {
...
export default ConservazionePage;
